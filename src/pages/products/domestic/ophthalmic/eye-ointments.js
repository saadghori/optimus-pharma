...
// 1. Filter all ointments from the domestic product list
const allOintments = domesticProducts.filter(p => p.nature === 'Ointment');
...
function EyeOintmentsPage() {
  ...
  const marketType = "domestic";

  return (
    <ProductLayout
      title="Eye Ointments"
      description="Our range of pharmaceutical eye ointments for the domestic market."
    >
      <h3 style={{
        textAlign: 'center',
        color: '#ff7823',
