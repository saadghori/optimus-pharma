...
import { supplementsDomestic } from '@/data/products';

const productsData = [
  { category: 'Syrups', products: supplementsDomestic.filter(p => p.category === 'Syrups') },
  { category: 'Tablets', products: supplementsDomestic.filter(p => p.category === 'Tablets') },
];
