...
const eyeDropsOnly = domesticProducts.filter(
...
const productsData = [
  ...
  { category: 'Steroids + Infectives Combinations', products: eyeDropsOnly.filter(p => p.category === 'STEROIDS + ANTI-INFECTIVES COMBINATIONS') },
